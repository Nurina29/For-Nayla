// ============================================
// DATA SCRAPBOOK NAYLA
// ============================================

const firstThought = [
  {
    author: "🥔 Umbi Kentang",
    text: "hal pertama yang aku inget kalau denger nama ka nayla adalah waco pendamping pkms, adeknya ka nana dan duta fakultas, hihiw"
  },
  {
    author: "🍠 Umbi Ubi Ungu",
    text: "Anak sulungku WKWKWKK. Dulu kamu protes nggak mau cuma dianggap praktikan, dan entah sejak kapan malah sekarang udah ku anggap adekku sendiri wkwk"
  },
  {
...
const ifTheyWere = [
  {
    ...
    reason: "soalnya ka nayla adalah salah satu orang teramah dan fun banget yang pernah aku temuin, hehehee"
  },
  {
    author: "🍠 Umbi Ubi Ungu",
...
const memories = [
  {
    author: "🥔 Umbi Kentang",
    text: "memori yang paling aku inget sudahh pastiii wkwkwkwk waktu aku samwis dan ketemu ka nayla, disitu aku dichallenge ka nana buat nyapa dan kenalan sama ka nayla, dan disitu aku bener-bener memberanikan diri buat menyapa ka nayla wkwkwk (sksd bgt pls), padahal maba jir berani-beraninya😳, eh terus feedback dari ka nayla malah asik dan berujung foto bareng, wkwkwkwkwk lucukkkkkkkkkkk sekaliiiiii💞"
  },
  {
    author: "🍠 Umbi Ubi Ungu",
...
const futureLetters = [
  {
    author: "🥔 Umbi Kentang",
    text: "makasiii banyaaak yaa ka naylaa udah jadi kakak yang baik buat akuu, dan jadi adik yang baik juga buat ka nana💖💙 bener-bener membanggakan sekaliii ka nayla inii. aku senenggg banget bisa kenal deket sama ka nayla, bahkan bisa jadi adeknya ka nayla yang kereeennn bangett hihihi, lovv banyaaak banyaaak💗💖 harapan aku buat ka naylaa, semoga di bertambahnya usia yang kali ini bisa jadi salah satu tahun terbaik ka nayy yaaa. semoga sehattt terus, bahagiaa terus, selalu dikelilingi orang-orang baik, dimudahin semuaa kegiatan sama cita-cita yang lagi diusahain sampe bener' tercapaiii, semoga rezekinya lancar, urusannya dipermudah, pokoknya semoga semua hal baik dateng terus ke ka naylaa💕💕💕SAMA SEMOGA CEPET DAPET COWO FK ITUHHH WKWKWKWK🤏🏻 jangan lupa makannnn, istirahatt dan utamain diri sendiri jugaaa, tapi jangan lupain keluarga umbiii yang imut kiyut lucuk🤏 sehat-sehat terus yaa ka nayy, semangattt terus, lovv sekebonnnn💞💞💞💗💗💗"
  },
  {
    author: "🍠 Umbi Ubi Ungu",
